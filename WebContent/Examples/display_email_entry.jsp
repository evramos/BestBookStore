...
<body>
    ...
    <%!
        ...
        public void add(User user, String filepath) throws IOException
        {
            ...
            out.println("Email:\t" + user.getEmailAddress());
    ...
    <%
        ...
        String path = sc.getRealPath("/WEB-INF/EmailList.txt"); // code that gets the absolute path for a file

        // use regular Java objects
        User user = new User(firstName, lastName, emailAddress);
        		
        // Use the UserIO class		
