...
// background-image: url(data:image/jpeg;base64,.....Base64img.....)


            out.println("<td background-image: url(data:image/jpeg;base64," + Base64.encodeBase64(IOUtils.toByteArray(bookList.get(i).getBookCoverArt())) + ") /></td>");
