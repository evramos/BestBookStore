		...
		<form action="BookUpdate" method="post">
			<fieldset>
				...
				<div><span class="star">*</span><label>  Title: </label>
					<input type="text" name="title" id="title"  value=<%=book.getTitle() %> require/></div>

				<div><span class="star">*</span><label>  Author: </label>
					<input type="text" name="author" id="author"  value=<%=book.getAuthor() %>required/></div>
					
				<div><span class="star">*</span><label>  Category: </label>
					<select name="category" value=<%=book.getCategory() %>>
				...
				<div><label> Description <br></label><textarea name="BookDiscription" rows="10" cols="80" value=value=<%=book.getBookDescription() %>></textarea></div>
